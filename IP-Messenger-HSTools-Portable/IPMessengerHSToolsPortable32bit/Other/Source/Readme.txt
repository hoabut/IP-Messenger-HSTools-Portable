...
user in an INI file next to IPMessengerHSToolsPortable32bit.exe called IPMessengerHSToolsPortable32bit.ini.
...
copy AppNamePortable.ini from this directory to IPMessengerHSToolsPortable32bit.ini next to
IPMessengerHSToolsPortable32bit.exe. The options in the INI file are as follows:
