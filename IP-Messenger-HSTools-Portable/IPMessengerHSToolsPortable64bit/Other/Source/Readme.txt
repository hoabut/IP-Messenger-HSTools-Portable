...
user in an INI file next to IPMessengerHSToolsPortable64bit.exe called IPMessengerHSToolsPortable64bit.ini.
...
copy AppNamePortable.ini from this directory to IPMessengerHSToolsPortable64bit.ini next to
IPMessengerHSToolsPortable64bit.exe. The options in the INI file are as follows:
