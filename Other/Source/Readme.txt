...
user in an INI file next to IPMessengerHSToolsPortable.exe called IPMessengerHSToolsPortable.ini.
...
copy AppNamePortable.ini from this directory to IPMessengerHSToolsPortable.ini next to
IPMessengerHSToolsPortable.exe. The options in the INI file are as follows:
